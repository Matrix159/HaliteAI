...
model_1v1 = load_model('model_checkpoint_128_batch_10_epochs.h5')
model_2v2 = load_model('model4v4_checkpoint_200_batch_10_epochs.h5')
model = None
VERSION = 0

HM_ENT_FEATURES = 5
game = hlt.Game("MatrixBot{}".format(VERSION))
logging.info("MatrixBot-{} Start".format(VERSION))
