...
in_model = 'model4v4_checkpoint_{}_batch_{}_epochs.h5'.format(0, 0)
out_model = 'model4v4_checkpoint_{}_batch_{}_epochs.h5'.format(batch_size, epochs)
...
np.save("train4v4_in.npy", train_in)
np.save("train4v4_out.npy", train_out)

train_in = np.load("train4v4_in.npy")
train_out = np.load("train4v4_out.npy")
